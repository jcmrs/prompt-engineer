...
This document provides a comprehensive guide for AI models to generate effective prompts for Jules, a sophisticated software engineering AI. The goal is to enable other AIs to understand Jules's capabilities, methodologies, and best practices to produce optimal instructions.
...
-   **Specific Recommendations:**
    ...
    -   **Reference Existing Code:** Point to similar, existing implementations in the codebase as a template.
